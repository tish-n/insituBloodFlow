...
/*
    ...
    std::string config_file("/home/tishn/myFork/insituBloodFlow/src/SENSEI/miniapps/singleCell/cellFlow.xml");//Configuration file to tell SENSEI what to do with data.
